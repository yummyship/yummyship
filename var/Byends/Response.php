...
class Byends_Response
{
     ...
     *
     * @access public
     * @return Byends_Response
     */
    public static function getInstance()
    {
        if (null === self::$_instance) {
            self::$_instance = new Byends_Response();
        }
    ...
    public function throwJson($message)
    {
        ...
        /** Byends_Json */
        require_once 'Byends/Json.php';
        echo Byends_Json::encode($message);
    ...
    public function redirect($location, $isPermanently = false)
    {
        /** Byends_Paragraph */
        require_once 'Byends/Paragraph.php';
        $location = Byends_Paragraph::safeUrl($location);
    ...
    public function goBack($suffix = null, $default = null)
    {
        ...
        if (!empty($referer)) {
            if (!empty($suffix)) {
                ...
                $referer = Byends_Paragraph::buildUrl($parts);
            }
