...
define( 'BYENDS_IMAGE_URL',				'http://'.$options->imageDomain.$subAbsolutePath );
...
define( 'BYENDS_AVATARS_STATIC_URL',	BYENDS_IMAGE_URL.__BYENDS_AVATARS_DIR__ );
define( 'BYENDS_COVERS_STATIC_URL',		BYENDS_IMAGE_URL.__BYENDS_COVERS_DIR__ );
define( 'BYENDS_THUMBS_STATIC_URL',		BYENDS_IMAGE_URL.__BYENDS_THUMBS_DIR__ );
define( 'BYENDS_STEPS_STATIC_URL',		BYENDS_IMAGE_URL.__BYENDS_STEPS_DIR__ );
define( 'BYENDS_TEMPS_STATIC_URL',		BYENDS_IMAGE_URL.__BYENDS_TEMPS_DIR__ );

define( 'BYENDS_NO_IMAGE_STATIC_URL',	BYENDS_IMAGE_URL.__BYENDS_DATA_DIR__.'default.png' );
define( 'BYENDS_NO_AVATAR_STATIC_URL',	BYENDS_IMAGE_URL.__BYENDS_AVATARS_DIR__.'default.jpg' );
